...
import {ConversationManager} from 'csm-poc-lib';
...
export class CSMService {
  ...
  // importing to library disabled this function
  // public regForBusy(regForBusyCallback: Function) {
  //   this._ProcessCommandService.regForBusy(regForBusyCallback);
  // }
}
